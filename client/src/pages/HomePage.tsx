...
import WizardProfile from "@/components/content/wizard-profile";
import ProjectsWindow from "@/components/content/projects-window";
import SkillsWindow from "@/components/content/skills-window";
import ContactWindow from "@/components/content/contact-window";
import DialogBox from "@/components/interactive/dialog-box";
import Clock from "@/components/navigation/clock";
import FolderIcon from "@/components/content/folder-icon";
import ManaBar from "@/components/navigation/mana-bar";
