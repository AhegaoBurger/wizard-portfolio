    ...
    >
      <div className="flex flex-col gap-3">
        <div className="border border-white p-2">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex">
              ...
              <input
                type="text"
                className="flex-1 pixel-input border border-white text-white text-xs p-1"
              />
            </div>
        ...
        <div className="flex justify-between">
          <button className="pixel-button px-2 py-1 text-white text-xs">
            CLEAR
          </button>
          <button className="pixel-button px-2 py-1 bg-white text-black text-xs">
            SEND
          </button>
        </div>
      </div>
