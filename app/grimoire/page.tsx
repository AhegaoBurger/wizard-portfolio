...
const projects: Project[] = [
  {
    ...
    type: "Web App",
    completion: 100,
    description: "A magical dashboard for monitoring spell effectiveness and tracking magical metrics in real-time.",
    features: ["Real-time data visualization", "User authentication", "Dark/light mode toggle", "Responsive design"],
  },
  {
    name: "Potion_Tracker",
    type: "Mobile App",
    completion: 85,
    description: "Track brewing status of your magical concoctions with this cross-platform mobile application.",
    features: ["Inventory management", "Recipe database", "Brewing timers", "Ingredient substitutions"],
  },
  {
    name: "Spell_Compiler",
    type: "Developer Tool",
    completion: 70,
    description: "Convert ancient runes to modern JavaScript with this innovative code transpiler.",
    features: ["Syntax highlighting", "Error detection", "Code optimization", "Multiple output formats"],
  },
  {
    name: "Familiar_Finder",
    type: "Web Service",
    completion: 100,
    description: "Match wizards with their perfect animal companions using advanced matching algorithms.",
    features: ["Personality assessment", "Compatibility scoring", "Animal database", "Match recommendations"],
  },
]
            ...
            <Window title="Project_Grimoire" width="w-80" height="h-96" x="left-4" y="top-4">
              <div className="flex flex-col gap-2 h-full">
                <div className="border border-white p-2 mb-2">
                  <h2 className="text-white text-center font-bold mb-2">MAGICAL PROJECTS</h2>
                  <p className="text-white text-xs text-center">Select a project to view details</p>
                </div>
